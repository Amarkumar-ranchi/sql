...
-- create table from customers with all columns and data 
...
create table myaddr4 as 
select * from address where city='blore';


-- create table from customers, accounts,address with required columns and data
